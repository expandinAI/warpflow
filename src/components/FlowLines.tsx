...
export function FlowLines() {
  ...
  const mobileLeftOffset = Math.sin(mobilePhase) * 50;
  const mobileRightOffset = Math.cos(mobilePhase) * 40;
  const mobileVertical = Math.sin(mobilePhase * 0.7) * 30;
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none -z-5">
      ...
      >
        {isMobile ? (
          ...
          <motion.path
            ...
            d={isLoaded ? undefined : "M 400 0 Q 100 250 300 500 Q 500 750 200 1000"}
          />
        )}
        <defs>
      ...
      >
        {isMobile ? (
          ...
          <motion.path
            ...
            d={isLoaded ? undefined : "M 0 0 Q 300 200 100 450 Q -100 700 200 1000"}
          />
        )}
        <defs>
      ...
      {/* Mobile: Subtle floating particles as alternative */}
