...
// Animated gradient border component for input
function AnimatedInputBorder({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="relative rounded-xl bg-bg-secondary">
        {children}
      </div>
    </div>
  );
