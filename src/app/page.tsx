    ...
    >
      ...
      <section className="relative w-full px-6 py-16 md:py-24">
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-2.5 mb-16 md:mb-20"
        >
          <motion.div
      ...
      <section className="relative w-full py-32 md:py-40 px-6">
        ...
        <div className="absolute inset-0 -z-10">
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-accent/10 rounded-full blur-[200px]"
          />
        </div>
      ...
      {/* FOOTER */}
      {/* ============================================ */}
      <footer className="relative w-full py-12 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            {/* Logo */}
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-accent to-blue-400 flex items-center justify-center">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
              ...
              <span className="text-text-primary font-medium">WarpFlow</span>
            </div>
